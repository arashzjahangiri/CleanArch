...
public interface ICacheService
{
    ...
    Task<TItem> GetOrCreateAsync<TItem>(string cacheKey, Func<CancellationToken, Task<TItem>> factory, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<TItem>> GetOrCreateAsync<TItem>(string cacheKey, Func<CancellationToken, Task<IReadOnlyList<TItem>>> factory, CancellationToken cancellationToken = default);
